...
function App() {
  ...
  // ==========================================
  // ALTERAÇÃO DO FORMULÁRIO DE ALUNO
  // ==========================================
  ...
  // ==========================================
  // ALTERAÇÃO DO FORMULÁRIO DE TURMA
  // ==========================================
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorText || 'Erro ao cadastrar aluno'
        );
      }
  ...
  const handleTurmaSubmit = async (event) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorText || 'Erro ao cadastrar turma'
        );
      }
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              textAlign="center"
            >
              Login ainda será implementado com
              autenticação real no próximo passo.
            </Typography>
        ...
        <Stack spacing={3}>
          ...
          {view === 'alunos' ? (
            ...
            >
              ...
              <Typography color="text.secondary">
                Esta área ficará disponível para
                a próxima etapa do sistema escolar.
              </Typography>
